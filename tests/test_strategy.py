...
@pytest.mark.parametrize(['strategy', 'strategy_info', 'rolls', 'correct_bets'], [
    ...
    (passline_odds, {}, [(4, 4)], {('PassLine', '', 5), ('Odds', '8', 5)}),
    (passline_odds, {}, [(4, 4), (3, 3)], {('PassLine', '', 5), ('Odds', '8', 5)}),
    (passline_odds, {'mult': '345'}, [], {('PassLine', '', 5)}),
    (passline_odds, {'mult': '345'}, [(6, 4)], {('PassLine', '', 5), ('Odds', '10', 15)}),
    (passline_odds2, {}, [(2, 2)], {('PassLine', '', 5), ('Odds', '4', 10)}),
    (passline_odds345, {}, [(3, 4), (3, 3)], {('PassLine', '', 5), ('Odds', '6', 25)}),
    (pass2come, {}, [], {('PassLine', '', 5)}),
    (pass2come, {}, [(4, 5)], {('PassLine', '', 5), ('Come', '', 5)}),
    (pass2come, {}, [(4, 5), (5, 5)], {('PassLine', '', 5), ('Come', '10', 5), ('Come', '', 5)}),
    (pass2come, {}, [(4, 5), (5, 5), (3, 3)], {('PassLine', '', 5), ('Come', '10', 5), ('Come', '6', 5)}),
    ...
    (place68, {}, [(4, 5)], {('PassLine', '', 5), ('Place6', '', 6), ('Place8', '', 6)}),
    (place68, {}, [(2, 4)], {('PassLine', '', 5), ('Place8', '', 6)}),
    (dontpass, {}, [], {('DontPass', '', 5)}),
    (layodds, {'win_mult': 1}, [], {('DontPass', '', 5)}),
    (layodds, {'win_mult': '345'}, [(3, 3)], {('DontPass', '', 5), ('LayOdds', '6', 30)}),
    (place68_2come, {}, [], set()),
    (place68_2come, {}, [(3, 3)], {('Place6', '', 6), ('Place8', '', 6), ('Come', '', 5)}),
    (place68_2come, {}, [(3, 3), (3, 6)], {('Place6', '', 6), ('Place8', '', 6), ('Come', '9', 5), ('Come', '', 5)}),
    (place68_2come, {}, [(3, 3), (4, 4)], {('Place6', '', 6), ('Place5', '', 5), ('Come', '8', 5), ('Come', '', 5)}),
    (ironcross, {}, [], {('PassLine', '', 5)}),
    (ironcross, {'mult': '2'}, [(4, 4)], {('PassLine', '', 5), ('Odds', '8', 10), ('Place5', '', 5),
                                          ('Place6', '', 6), ('Field', '', 5)}),
    (hammerlock, {}, [], {('PassLine', '', 5), ('DontPass', '', 5)}),
    (hammerlock, {}, [(3, 3)], {('PassLine', '', 5), ('DontPass', '', 5), ('Place6', '', 6), ('Place8', '', 6),
                                ('LayOdds', '6', 30)}),
    (hammerlock, {}, [(3, 3), (4, 4)], {('PassLine', '', 5), ('DontPass', '', 5), ('Place6', '', 6), ('Place8', '', 6),
                                        ('LayOdds', '6', 30), ('Place5', '', 5), ('Place9', '', 5)})
])
