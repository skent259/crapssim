...
from crapssim.bet import PassLine, Odds8, Odds10, Odds4, Odds6, Come, Place, DontPass, LayOdds6, \
    Field, DontCome, LayOdds4, Odds, LayOdds
from crapssim.strategy import BetPassLine, PassLineOdds, BetPlace, BetDontPass, BetDontPassOdds, \
    BetIfTrue
...
[(BetPassLine(bet_amount=5), [], [PassLine(bet_amount=5.0)]),
 ...
 (BetPassLine(bet_amount=5) + PassLineOdds(odds_multiplier=1),
  [(4, 4)],
  [Odds(8, bet_amount=5.0), PassLine(bet_amount=5.0)]),
 (BetPassLine(bet_amount=5) + PassLineOdds(odds_multiplier=1),
  [(4, 4), (3, 3)],
  [Odds(8, bet_amount=5.0), PassLine(bet_amount=5.0)]),
 ...
 (BetDontPass(bet_amount=5) + BetDontPassOdds(odds_multiplier=6),
  [(3, 3)],
  [LayOdds(6, bet_amount=30.0), DontPass(bet_amount=5.0)]),
 ...
 (Knockout(bet_amount=5),
  [(4, 2)],
  [DontPass(bet_amount=5.0), PassLine(bet_amount=5.0), Odds(6, bet_amount=25.0)]),
